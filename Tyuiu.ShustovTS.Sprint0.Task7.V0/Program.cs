...
using using Tyuiu.ShustovTS.Sprint0.Task7.V0.Lib;

namespace using Tyuiu.ShustovTS.Sprint0.Task6.V0
{
    class Program
{
    static void Main(string[] args)
    {
        Console.Title = "Спринт #0 | Выполнил Шустов Т. С. | АСОиУб-23-2";
        Console.WriteLine("***************************************************************************************************");
